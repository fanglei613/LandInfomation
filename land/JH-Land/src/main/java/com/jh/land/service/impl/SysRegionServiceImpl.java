...
import com.jh.land.enums.RegionEnum;
import com.jh.land.mapping.ISysRegionMapper;
import com.jh.land.model.RegionAppReturn;
...
@Service
@Transactional
public class SysRegionServiceImpl extends BaseServiceImpl<RegionParam, InitRegion, Long> implements ISysRegionService {
    @Autowired
    private ISysRegionMapper regionMapper;
