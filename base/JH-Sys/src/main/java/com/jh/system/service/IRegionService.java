 ...
 *      新增接口
 */
public interface IRegionService  extends IBaseService<RegionParam, InitRegion, Long>{
    /**
     ...
     * @version <1> 2018/1/26 djh： Created.
     */
    ResultMessage updateInitRegionByInitRegionId(HttpServletRequest request, InitRegion initRegion);
     ...
     * @version <1> 2018/1/26 djh： Created.
     */
    ResultMessage saveInitRegion(HttpServletRequest request, InitRegion initRegion);
     ...
     * @version <1> 2018/1/26 djh： Created.
     */
    ResultMessage deleteInitRegionByInitRegionId(HttpServletRequest request, InitRegion initRegion);
