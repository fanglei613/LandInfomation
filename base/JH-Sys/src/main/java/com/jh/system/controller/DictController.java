...
public class DictController {
     ...
     */
    @ApiOperation(value="查询子字典数据",notes="通过父主键,查询子字典数据")
    @ApiImplicitParam(name = "parentId",value = "父主键",required = true, dataType = "Integer")
    @PostMapping(value = "queryDictChildrenByParentId")
    public ResultMessage queryDictChildrenByParentId(@RequestParam Integer parentId){
        return dictService.findDictByParamId(parentId);
    }
